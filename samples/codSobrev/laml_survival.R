...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  laml  ####
##########################################################
##########################################################
setwd("E:/ArtigoJosivan/samples/Non_log/lamlNon")
...
menos <- "GTSF1_0.02_peak1_cluster1.lst"
...
setwd("E:/ArtigoJosivan/survival/not_log/laml_Non")
##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("laml_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
