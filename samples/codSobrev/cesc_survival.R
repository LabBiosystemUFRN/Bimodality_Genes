...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  cesc  ####
##########################################################
##########################################################
setwd("E:/ArtigoJosivan/samples/Non_log/cescNon")
...
menos <- c("ANXA8L2_0.02_peak1_cluster1.lst","GPR87_0.02_peak1_cluster1.lst","TMEM40_0.02_peak1_cluster1.lst","SMC1B_0.02_peak1_cluster1.lst")
...
setwd("E:/ArtigoJosivan/survival/not_log/cescNon")
##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("cesc_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
