...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  stad  ####
##########################################################

##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("stad_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
...
##########################################################
setwd("E:/ArtigoJosivan/samples/stadNon")
...
setwd("E:/ArtigoJosivan/survival/stadNon")


# Função para gerar gráficos e summary de testes de sobrevivencia

tumor="stad"
aux = dados[dados$Tumor == "stad",]
