...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  kirc  ####
##########################################################
##########################################################
setwd("E:/ArtigoJosivan/samples/Non_log/kircNon")
...
clinical <- read.csv("kirc_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
...
setwd("E:/ArtigoJosivan/survival/kircNon")


# Função para gerar gráficos e summary de testes de sobrevivencia

tumor="kirc"
aux = dados[dados$Tumor == "kirc",]
