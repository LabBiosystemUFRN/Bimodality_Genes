...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  thca  ####
##########################################################

##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("thca_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
...
##########################################################
setwd("E:/ArtigoJosivan/samples/thcaNon")
...
menos <- "GSTT1_0.02_peak1_cluster1.lst"
...
setwd("E:/ArtigoJosivan/survival/thcaNon")


# Função para gerar gráficos e summary de testes de sobrevivencia

tumor="thca"
aux = dados[dados$Tumor == "thca",]
