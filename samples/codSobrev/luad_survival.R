...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  luad  ####
##########################################################

setwd("E:/ArtigoJosivan/survival/luadLog")
##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("luad_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
...
##########################################################
setwd("E:/ArtigoJosivan/samples/luadNon")
...
menos <- "ZFY_0.02_peak1_cluster1.lst"
...
setwd("E:/ArtigoJosivan/survival/luadNon")


# Função para gerar gráficos e summary de testes de sobrevivencia

tumor="luad"
aux = dados[dados$Tumor == "luad",]
