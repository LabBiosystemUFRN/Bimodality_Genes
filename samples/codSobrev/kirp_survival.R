...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  kirp  ####
##########################################################
##########################################################
setwd("E:/ArtigoJosivan/samples/kirpNon")
...
clinical <- read.csv("kirp_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
...
setwd("E:/ArtigoJosivan/survival/kirpNon")


# Função para gerar gráficos e summary de testes de sobrevivencia

tumor="kirp"
aux = dados[dados$Tumor == "kirp",]
