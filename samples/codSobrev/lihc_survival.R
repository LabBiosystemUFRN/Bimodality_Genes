...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  lihc  ####
##########################################################

setwd("E:/ArtigoJosivan/survival/lihcLog")
##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("lihc_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
...
##########################################################
setwd("E:/ArtigoJosivan/samples/lihcNon")
...
setwd("E:/ArtigoJosivan/survival/lihcNon")


# Função para gerar gráficos e summary de testes de sobrevivencia

tumor="lihc"
aux = dados[dados$Tumor == "lihc",]
