...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  gbm  ####
##########################################################
##########################################################
setwd("E:/ArtigoJosivan/samples/Non_log/gbmNon")
...
setwd("E:/ArtigoJosivan/survival/not_log/gbm_Non")
##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("gbm_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
