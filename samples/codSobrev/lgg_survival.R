...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  lgg  ####
##########################################################
##########################################################
setwd("E:/ArtigoJosivan/samples/Non_log/lggNon")
...
menos <- "TTTY15_0.02_peak1_cluster1.lst"
...
setwd("E:/ArtigoJosivan/survival/not_log/lgg_Non")
##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("lgg_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
