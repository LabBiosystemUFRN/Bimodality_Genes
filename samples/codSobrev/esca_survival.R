...
##########################################################
###   ORGANIZACÃO E FILTRAGEM DA BASE DE DADOS  esca  ####
##########################################################
##########################################################
setwd("E:/ArtigoJosivan/samples/Non_log/escaNon")
...
files1 <- c(files1.2,files1.3)
#menos <- "EYA2_0.02_peak1_cluster1.lst"
...
setwd("E:/ArtigoJosivan/survival/not_log/esca_Non")
##### Dados clinicos TCGA - cbioportal
clinical <- read.csv("esca_clinical_patient.txt", sep = '\t', header = F, stringsAsFactors = F)
